...
// React.createElement("h1", { className: "h" }, "Hello world");
// function Author(props) {
//   return <h4> {props.id} </h4>;
// }

// function Welcome(props) {
//   const head = <Author id="sai" />;
//   return head;
// }
...
//   return (<button onClick={(event) => {buttonclick(props.number)}}> Button </button>);
// }
